---
name: README
description: 'Project-scoped commands for **voice-seed**. They travel with the repo.'
---

<!--
Generated from Claude slash command source.
Do not hand-edit this generated Codex skill. Edit the source command, then rerun sync-command-skills.ps1.

Command: /README
Source: $SYNA_SUITE_PATH/voice-seed/.claude/commands/README.md
Scope: project
Project: $SYNA_SUITE_PATH/voice-seed
-->
